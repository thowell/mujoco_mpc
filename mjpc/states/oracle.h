...
#ifndef MJPC_STATES_ORACLE_H_
#define MJPC_STATES_ORACLE_H_
...
class Oracle : public State {
 public:
  ...
  void CopyTo(double* dst_state, double* dst_mocap, double* dst_userdata, double* time) const override;
