...
#ifndef MJPC_TASKS_GO1_QUADRUPED_H_
#define MJPC_TASKS_GO1_QUADRUPED_H_
...
class Go1 : public Task {
 public:
  std::string Name() const override;
  std::string XmlPath() const override;
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    explicit ResidualFn(const Go1* task) : mjpc::BaseResidualFn(task) {}
   ...
   private:
    ...
    // feet
    enum Go1Foot { kFootFL = 0, kFootRL, kFootFR, kFootRR, kNumFoot };
    ...
    //  ============  constants  ============
    constexpr static Go1Foot kFootAll[kNumFoot] = {kFootFL, kFootRL, kFootFR,
                                                   kFootRR};
    constexpr static Go1Foot kFootHind[2] = {kFootRL, kFootRR};
    constexpr static Go1Gait kGaitAll[kNumGait] = {
        kGaitStand, kGaitWalk, kGaitTrot, kGaitCanter, kGaitGallop};
    ...
    // unitless    Hz       meter      unitless  unitless  unitless
      ...
      {0.4,        4,       0.015,     0.03,     0.5,      0.2},    // canter
    ...
    void FootStep(double step[kNumFoot], double time, Go1Gait gait) const;
    ...
    Go1Mode current_mode_       = kModeQuadruped;
...
#endif  // MJPC_TASKS_GO1_QUADRUPED_H_
