...
#ifndef MJPC_PLANNERS_CMA_POLICY_H_
#define MJPC_PLANNERS_CMA_POLICY_H_
...
class CMAPolicy : public Policy {
 public:
  ...
  // copy policy
  void CopyFrom(const CMAPolicy& policy, int horizon);
...
#endif  // MJPC_PLANNERS_CMA_POLICY_H_
